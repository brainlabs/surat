            ...
            <tbody>
              ...
              <tr>
               ...
               <td><?php echo $surat_masuk['disposisi']; ?></td>
                ...
                <td>                   
                    <button class="btn btn-sm  btn-warning" data-toggle="modal" data-target=".surat-keluar" nilai="<?php echo $surat_masuk['surat_masuk_id'] ?>" id="detail" data-tooltip="tooltip" data-placement="right" title="Lihat Detail">
