...
<head>
    ...
    <link href="<?php echo base_url(); ?>assets/fullcalendar-2.0.0/fullcalendar.css" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url(); ?>assets/fullcalendar-2.0.0/fullcalendar.print.css" rel="stylesheet" type="text/css">
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/fullcalendar-2.0.0/lib/moment.min.js"></script>
            ...
            <ul class="nav navbar-nav navbar-right">                
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">    
                        ...
                        <li><a href="<?php echo site_url('pegawai/ganti_password'); ?>"  data-toggle="modal-ajax"><i class="glyphicon glyphicon-edit"></i> Ganti Password</a></li>  
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/fullcalendar-2.0.0/lib/jquery-ui.custom.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/fullcalendar-2.0.0/fullcalendar.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/fullcalendar-2.0.0/gcal.js"></script>

<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/app.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/agenda.js"></script>
